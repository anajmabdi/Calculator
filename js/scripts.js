...
window.alert("The result of adding is: " + add(number1, number2) + "," + " subtracting is: " + subtract(number1, number2) + "," + " multiplying is: " + multiply(number1, number2) + " and dividing is: " + divide(number1, number2)+ ".");